...
(* OASIS_START *)
(* DO NOT EDIT (digest: 8f0320db9088e1116ec9865d73f28e07) *)
(*
...
let setup_t =
  {
     ...
     package =
       {
          ...
          copyrights =
            ["(C) 2001-2012 Markus Mottl <markus.mottl@gmail.com>"];
          maintainers = ["Markus Mottl <markus.mottl@gmail.com>"];
          authors = ["Markus Mottl <markus.mottl@gmail.com>"];
          homepage = Some "https://bitbucket.org/mmottl/pomap";
               ...
               SrcRepo
                 ({
                     ...
                     },
                   {
                      src_repo_type = Hg;
                      src_repo_location =
                        "ssh://hg@bitbucket.org/mmottl/pomap";
                      src_repo_browser =
                        Some "https://bitbucket.org/mmottl/pomap";
     ...
     oasis_version = "0.3.0";
     oasis_digest = Some "\024Á\141A\029FÔð\158¤NH&\135\017\135";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false;
     };;
