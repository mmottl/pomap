...
(* OASIS_START *)
(* DO NOT EDIT (digest: 61b3b1e613ddd2f15b57a92a46e99e2f) *)
(*
...
let setup_t =
  {
     ...
     package =
       {
          ...
          copyrights =
            ["(C) 2001-2016 Markus Mottl <markus.mottl@gmail.com>"];
          maintainers = ["Markus Mottl <markus.mottl@gmail.com>"];
          authors = ["Markus Mottl <markus.mottl@gmail.com>"];
          homepage = Some "http://mmottl.github.io/pomap";
          bugreports = None;
               ...
               Executable
                 ({
                  ...
                  },
                   {
                      ...
                      bs_path = "examples/hasse";
                      bs_compiled_object = Best;
                      bs_build_depends = [InternalLibrary "pomap"];
                      bs_build_tools =
                        [ExternalTool "ocamldoc"; ExternalTool "ocamlbuild"];
                      bs_interface_patterns =
                        [
                   ...
                   {exec_custom = false; exec_main_is = "hasse.ml"});
               Doc
                 ({
                     cs_name = "API";
                     cs_data = PropList.Data.create ();
               ...
               SrcRepo
                 ({
                  ...
                  },
                   {
                      src_repo_type = Git;
                      src_repo_location =
                        "https://github.com/mmottl/pomap.git";
                      src_repo_browser =
                        Some "https://github.com/mmottl/pomap";
     ...
     oasis_version = "0.4.8";
     oasis_digest = Some "\238\236\174\141\151\240\018 \019\197\132jU\b$\234";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
